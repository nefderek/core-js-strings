...
function isPalindrome(str) {
  ...
  let str1 = str0.split('').reverse().join('').replace(/[^\w\s]|_/g, "");
  let str3 = str1.split(' ').join('');
  let str2 = str0.toLowerCase().split(' ').join('').replace(/[^\w\s]|_/g, "");
  if (str2 === str3) {
    return true;
  }
  return false;
